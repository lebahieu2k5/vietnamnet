...
class PageController extends BackendController
{
            ...
            */
            ...
            if($request->isGet){
                return [
                    ...
                    'content'=>$this->renderAjax('newpage', [
                        'model' => $model,
                    ]),
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
                        Html::button('Save',['class'=>'btn btn-primary','type'=>"submit"])
    ...
    public function actionDelete($id)
    {
        ...
        if(isset($model)){
            ...
            if(file_exists($rootFolder.$model->image) && preg_match("/^\/images\/page\//i", $model->image)>0){
                unlink($rootFolder.$model->image);
            }
    ...
    {
        $page = Page::find()->where(['id'=>$_POST['id']])->one();
        Page::updateAll(['active'=>(1-$page->active)],['id'=>$page->id]);
    }
