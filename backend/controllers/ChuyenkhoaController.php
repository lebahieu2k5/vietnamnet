 ...
 */
class ChuyenkhoaController extends BackendController
{
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new Chuyenkhoa",
                    'content'=>'<span class="text-success">Create Chuyenkhoa success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
